...
@AllArgsConstructor
public class WashingCrushingItemAdapter extends RecyclerView.Adapter<WashingCrushingItemAdapter.MyHolder> {
    FragmentActivity context;
    List<Item> previousOrderItem;
    ...
    public void onBindViewHolder(@NonNull @NotNull MyHolder holder, int position) {
        Item currentItem =  previousOrderItem.get(position);
