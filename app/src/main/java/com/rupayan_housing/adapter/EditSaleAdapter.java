...
public class EditSaleAdapter extends RecyclerView.Adapter<EditSaleAdapter.MyHolder> {
    private FragmentActivity context;
    private List<SalesRequisitionItems> list;
    private EditSaleData itemClick;

    public EditSaleAdapter(FragmentActivity context, List<SalesRequisitionItems> itemsList, EditSaleData editSaleData) {
    ...
    public void onBindViewHolder(@NonNull @NotNull MyHolder holder, int position) {
        ...
        EditSaleData.binding.totalQuantity.setText("Total Quantity: " + String.valueOf(totalQuantity));
        ...
        holder.binding.setClickHandle(new NewSaleProductListClickHandle() {
            ...
            public void addQuantity() {
               ...
               /* if (productStockResponse != null) {
                ...
                List<String> quantityList = EditSaleData.getAllQuantity();
                ...
                try {
                    EditSaleData.binding.totalQuantity.setText("Total Quantity: " + String.valueOf(total));
                } catch (Exception e) {
