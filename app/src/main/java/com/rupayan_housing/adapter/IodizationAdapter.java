...
import com.rupayan_housing.view.fragment.production.iodization.addNew.IodizationFragment;
import com.rupayan_housing.view.fragment.production.iodization.addNew.IodizationRecyclerItemClickHandle;
...
public class IodizationAdapter extends RecyclerView.Adapter<IodizationAdapter.MyHolder> {
    ...
    public IodizationAdapter(FragmentActivity context,
                             ...
                             IodizationRecyclerItemClickHandle itemClick) {
    ...
    public void onBindViewHolder(@NonNull @NotNull MyHolder holder, int position) {
        ...
        ProductStockListResponse stockListResponse =    productStockResponse.get(position);
