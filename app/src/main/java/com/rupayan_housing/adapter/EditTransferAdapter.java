...
import com.rupayan_housing.view.fragment.transfer.edit.EditTransferData;
import com.rupayan_housing.view.fragment.transfer.edit.EditTransferItemClick;
...
public class EditTransferAdapter extends RecyclerView.Adapter<EditTransferAdapter.MyHolder> {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        NewSaleProductListModelBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()),R.layout.new_sale_product_list_model, parent, false);
