...
public class EditedSalePreviousAdapter extends RecyclerView.Adapter<EditedSalePreviousAdapter.MyHolder>{

    FragmentActivity context;
    List<Item> itemList;


    public EditedSalePreviousAdapter(FragmentActivity context, List<Item> itemList) {
