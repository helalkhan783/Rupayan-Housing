...
@AllArgsConstructor
public class CreditorsViewModel extends ViewModel {


    public MutableLiveData<CreditorsResponse> getCreditors(FragmentActivity context) {
